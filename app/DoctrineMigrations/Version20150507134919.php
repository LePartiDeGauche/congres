 ...
 */
class Version20150507134919 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE amendments (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, text_id INT DEFAULT NULL, start_line INT NOT NULL, amendment_type VARCHAR(255) NOT NULL, amendment_content LONGTEXT NOT NULL, INDEX IDX_D287B73F675F31B (author_id), INDEX IDX_D287B73698D3548 (text_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
